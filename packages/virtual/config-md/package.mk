...
PKG_SECTION="virtual"
PKG_SHORTDESC="config-md: Metapackage for kernel option CONFIG_MD to install cryptsetup, lvm2, mdadm packages"
PKG_LONGDESC="config-md: Metapackage for kernel option CONFIG_MD to install cryptsetup, lvm2, mdadm packages"
